      ...
      entries: [
        {
          ...
          points: [
            ...
            "В финале разработал программу, обходящую сайт в порядке обхода в ширину и составляющую коллаж из картинок. Данные в память не помещались, поэтому разобрался как устроен формат PNG и написал побайтовую генерацию изображения. Чтобы решение работало за разумное время, обход производил в несколько потоков.",
